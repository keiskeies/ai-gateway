...
/// Restart hint - returns a message telling the user to restart
pub async fn restart_hint() -> HttpResponse {
    HttpResponse::Ok().json(serde_json::json!({
        "message": "Configuration saved. Some changes (like admin port) require a restart to take effect.",
